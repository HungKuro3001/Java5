	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-4 mt-3">
				<form action="/ASM_Java4/admin/categories/index" method="get">
					<div class="row">
						<div class="col-8">
			...
			<div class="modal fade" id="exampleModal" tabindex="-1"
				...
				<div class="modal-dialog modal-lg">
					<div class="modal-content ">
						<form action="/ASM_Java4/admin/categories/store" method="post">
				...
				<tbody>
					...
					data-bs-target="#edit${ca.id }" >Edit</button>
								<div class="modal fade" id="edit${ca.id }" tabindex="-1"
									...
									<div class="modal-dialog modal-lg">
										<div class="modal-content ">
											<form action="/ASM_Java4/admin/categories/update?id=${ca.id }" method="post">
												<div class="modal-header">
													<h5 class="modal-title" id="exampleModalLabel">Thêm	mới</h5>
										...
										<div class="modal-content">
											...
											<div class="modal-footer">
												...
												<a type="button" class="btn btn-primary"
													href="/ASM_Java4/admin/categories/delete?id=${ca.id }">Xác nhận</a>
											</div>
										</div>
									</div>
								</div>
