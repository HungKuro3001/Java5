...
<main>
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-1"></div>
			<div class="col-9">
				<form action="/ASM_Java4/admin/orders/update?id=${hoadon.id}" method="post">
					...
					<div class="col-6">
					 <label class="fw-bold mt-4">Số
						...
						<div class="col-6"> <label class="fw-bold mt-4">Phương thức : </label> <input
							...
							value="${hoadon.phuongThuc==0?'Thanh toán sau khi trả':'Thanh toán online' }">
							</div>
						</div>
				<label
						...
						<select name="status"
							class="form-select">
							<option value="0" ${hoadon.tinhTrang == 0 ?'selected':'' }>Chờ
								xác nhận</option>
							<option value="1" ${hoadon.tinhTrang == 1 ?'selected':'' }>Đang
								giao</option>
							<option value="2" ${hoadon.tinhTrang == 2 ?'selected':'' }>Đã
								hủy</option>
							<option value="3" ${hoadon.tinhTrang == 3 ?'selected':'' }>Đã
								giao</option>
						</select>
					</div>
