			...
			<div class="modal fade" id="exampleModal" tabindex="-1"
				...
				<div class="modal-dialog modal-lg">
					<div class="modal-content ">
						<form action="/ASM_Java4/admin/users/store" method="post">
				...
				<tbody>
					...
					data-bs-target="#edit${user.id }" >Edit</button>
								<div class="modal fade" id="edit${user.id }" tabindex="-1"
									...
									<div class="modal-dialog modal-lg">
										<div class="modal-content ">
											<form action="/ASM_Java4/admin/users/update`?id=${user.id }" method="post">
												<div class="modal-header">
													<h5 class="modal-title" id="exampleModalLabel">Thêm	mới</h5>
										...
										<div class="modal-content">
											...
											<div class="modal-footer">
												...
												<a type="button" class="btn btn-primary"
													href="/ASM_Java4/admin/users/delete=${user.id }">Xác nhận</a>
											</div>
										</div>
									</div>
								</div>
			...
			<div class="row justify-content-center">
				...
				<div class="col-6">
					<nav aria-label="Page navigation example">
						<ul class="pagination">
							<li class="page-item"><a class="page-link" href="/ASM_Java4/admin/users/index?name=${name }&page=1"
								aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
							</a></li>
							<c:forEach var="p" begin="1" end="${pageCount}">
								<li class="page-item"><a class="page-link"
									href="/ASM_Java4/admin/users/index?name=${name }&page=${p}">${p }</a></li>
							</c:forEach>
							<li class="page-item"><a class="page-link" href="/ASM_Java4/admin/users/index?name=${name }&page=${pagecount}"
