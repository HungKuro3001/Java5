	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-4 mt-3">
				<form action="//ASM_Java4/admin/products/index" method="get">
					<div class="row">
						<div class="col-8">
			...
			<div class="modal fade" id="exampleModal" tabindex="-1"
				...
				<div class="modal-dialog modal-lg">
					<div class="modal-content ">
						...
						<form action="/ASM_Java4/admin/products/store" method="post"
					...
					<c:forEach var="p" items="${items }">
						<tr>
							...
							<td><img alt="" class="img-fluid"
								src="/ASM_Java4/image/${p.img }" height="200px" width="200px">
							</td>
							<td>
								...
								<div class="modal fade" id="edit${p.id }" tabindex="-1"
									...
									<div class="modal-dialog modal-lg">
										<div class="modal-content ">
											...
											<form action="/ASM_Java4/admin/products/update?id=${p.id }" method="post"
												enctype="multipart/form-data">
												<div class="modal-body mt-4">
													<div class="row">
														<div class="col-5">
															<img alt="" class="img-fluid" src="/ASM_Java4/image/${p.img }">
														</div>
														<div class="col-7">
										...
										<div class="modal-content">
											...
											<div class="modal-footer">
												...
												<a type="button" class="btn btn-primary"
													href="/ASM_Java4/admin/products/delete?id=${p.id }">Xác nhận</a>
											</div>
										</div>
									</div>
								</div>
					...
					<nav aria-label="Page navigation example">
						<ul class="pagination">
							<li class="page-item"><a class="page-link"
								href="/ASM_Java4/admin/products/index?name=${name }&page=1"
								aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
							</a></li>
							<c:forEach var="p" begin="1" end="${pagecount }">
								<li class="page-item"><a class="page-link"
									href="/ASM_Java4/admin/products/index?name=${name }&page=${p}">${p }</a></li>
							</c:forEach>

							<li class="page-item"><a class="page-link"
								href="/ASM_Java4/admin/products/index?name=${name }&page=${pagecount}"
