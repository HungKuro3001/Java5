    ...
    <section class="pt-5 pb-5">
      <div class="container">
                        ...
                        <tr>
                            <td data-th="Product">
                                <div class="row">
                                    <div class="col-md-3 text-left">
                                        <img src="/ASM_Java4/image/${item.product.img }" alt="" class="img-fluid d-none d-md-block rounded mb-2 shadow ">
                                    </div>
                                    <div class="col-md-9 text-left mt-sm-2">
                                        <h4> <a href="/ASM_Java4/users/productDetail?id=${item.product.id}"> ${item.product.ten }</a></h4>
                            ...
                            <td class="actions" data-th="">
                                <div class="text-center">
                                    <a class="btn btn-white border-secondary bg-white btn-md mb-2" href="/ASM_Java4/users/xoaitem?id=${item.product.id}">
        ...
        <div class="row mt-4 d-flex align-items-center">
            <div class="col-6 ">
                <a href="/ASM_Java4/users/index">
                    <i class="fas fa-arrow-left mr-2"></i> Continue Shopping</a>
            </div>
            <div class="col-4"></div>
            <div class="col-2">
            <form action="/ASM_Java4/users/thanhtoan" method="post">
