...
public class UserValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		ValidationUtils.rejectIfEmpty(errors, "name", "error.name", "Họ tên không được bỏ trống");
		ValidationUtils.rejectIfEmpty(errors, "sdt", "error.sdt", "Số điện thoại không được bỏ trống");
