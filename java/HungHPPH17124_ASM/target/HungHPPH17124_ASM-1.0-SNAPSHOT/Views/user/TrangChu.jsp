...
<head>
    ...
    <link href="${pageContext.request.contextPath}/Views/css/style.css" rel="stylesheet" type="text/css" media="all"/>
    <link href="${pageContext.request.contextPath}/Views/css/form.css" rel="stylesheet" type="text/css" media="all"/>
    <link href='http://fonts.googleapis.com/css?family=Exo+2' rel='stylesheet' type='text/css'>
    <script type="text/javascript" src="${pageContext.request.contextPath}/Views/js/jquery1.min.js"></script>
    <!-- start menu -->
    <link href="${pageContext.request.contextPath}/Views/css/megamenu.css" rel="stylesheet" type="text/css" media="all"/>
    <script type="text/javascript" src="${pageContext.request.contextPath}/Views/js/megamenu.js"></script>
    <script>$(document).ready(function () {
        $(".megamenu").megamenu();
    });</script>
    <!--start slider -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/Views/css/fwslider.css" media="all">
    <script src="${pageContext.request.contextPath}/Views/js/jquery-ui.min.js"></script>
    <script src="${pageContext.request.contextPath}/Views/js/css3-mediaqueries.js"></script>
    <script src="${pageContext.request.contextPath}/Views/js/fwslider.js"></script>
    <!--end slider -->
    <script src="${pageContext.request.contextPath}/Views/js/jquery.easydropdown.js"></script>
</head>
<body>
...
<div class="header-bottom">
    <div class="wrap">
        <div class="header-bottom-left">
            <div class="logo">
                <a href="index.html"><img src="${pageContext.request.contextPath}/Views/images/logo.png" alt=""/></a>
            </div>
            <div class="menu">
...
<div id="fwslider">
    <div class="slider_container">
        <div class="slide">
            <!-- Slide image -->
            <img src="${pageContext.request.contextPath}/Views/images/banner.jpg" alt=""/>
            <!-- /Slide image -->
            <!-- Texts container -->
        ...
        <div class="slide">
            <img src="${pageContext.request.contextPath}/Views/images/banner1.jpg" alt=""/>
            <div class="slide_content">
                <div class="slide_content_wrap">
                        ...
                        <a href="single.html">
                            <div class="inner_content clearfix">
                                <div class="product_image">
                                    <img src="${pageContext.request.contextPath}/Views/images/pic.jpg" alt=""/>
                                </div>
                ...
                <div class="top-box1">
                    ...
                    <div class="col_1_of_3 span_1_of_3">
                        <a href="single.html">
                            <div class="inner_content clearfix">
                                <div class="product_image">
                                    <img src="${pageContext.request.contextPath}/Views/images/pic4.jpg" alt=""/>
                                </div>
                                <div class="price">
                                    <div class="cart-left">
                                        <p class="title">Lorem Ipsum simply</p>
    ...
    <div class="footer-top">
        <div class="wrap">
            <div class="section group example">
                ...
                <div class="col_1_of_2 span_1_of_2">
                    <ul class="f-list">
                        <li><img src="images/3.png"><span class="f-text">Call us! toll free-222-555-6666 </span>
                            <div class="clear"></div>
                        </li>
                    </ul>
                </div>
